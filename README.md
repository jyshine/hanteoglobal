...
## [1번 문제 제출 소스코드](https://github.com/jyshine/hanteoglobal/blob/main/task-result/src/main/java/task1/TaskRun.java)
...
출력: 5
설명: 다섯 가지 솔루션이 있습니다.
{2,2,2,2,2}, {2,2,3,3}, {2,2,6}, {2,3,5} 및 {5,5}.<br>
## [2번 문제 제출 소스코드](https://github.com/jyshine/hanteoglobal/blob/main/task-result/src/main/java/task2/TaskRun2.java)
